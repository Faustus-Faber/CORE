...
export function ProfilePage() {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      {isVolunteer && (
        <>
          {/* Write a review section — only visible to non-volunteer viewers;
              volunteers see their OWN reviews received below */}
          <section className="col-span-full rounded-xl bg-white p-6 shadow-panel ring-1 ring-slate-200">
            <h2 className="mb-4 text-xl font-bold text-ink">Reviews Received</h2>
            <ReviewList
              volunteerId={user.id}
      ...
      {!isVolunteer && (
        <section className="col-span-full rounded-xl bg-white p-6 shadow-panel ring-1 ring-slate-200">
          <h2 className="mb-1 text-xl font-bold text-ink">Leave a Review</h2>
          <p className="mb-4 text-sm text-slate-500">
            You can review a volunteer from their public profile page.
          </p>
        </section>
      )}
    </div>
